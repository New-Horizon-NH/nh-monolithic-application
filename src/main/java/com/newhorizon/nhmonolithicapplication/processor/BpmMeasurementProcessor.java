...
@Slf4j
public class BpmMeasurementProcessor implements MeasurementProcessor<BpmMeasurement> {
    private final WriteApiBlocking writeApi;

    @Override
    public void process(MeasurementDataMessage<BpmMeasurement> measurementDataMessage,
